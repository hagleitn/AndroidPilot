...
public class FlightConfiguration {
	...
	private static final float[] HOVER_CONF = { 0.57f, 0.0007f, 350f, -6000f,
			40000f };
	private static final float[] LANDING_CONF = { 0, 0.001f, 600f, -10000f,
			10000f };
	private static final float[] ORIENTATION_CONF = { 0.5f, 0.0007f, 200f,
			-6000f, 40000f };
	...
	private static final int MIN_THROTTLE = QuadCopter.MIN_SPEED
			+ (QuadCopter.MAX_SPEED - QuadCopter.MIN_SPEED) / 3;
	private static final int MAX_THROTTLE = QuadCopter.MAX_SPEED
			- (QuadCopter.MAX_SPEED - QuadCopter.MIN_SPEED) / 8;
